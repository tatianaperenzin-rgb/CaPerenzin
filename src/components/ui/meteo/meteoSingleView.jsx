        ...
        <BubbleFrame color="bg-transparentr" className="h-dvh" >
            ...
            <div className="flex flex-col h-dvh w-full justify-between z-20 py-30 xs:py-37 px-10 xs:px-14 md:px-20 lg:px-30 2xl:px-50">
                ...
                <div className="flex flex-col gap-5 xs:gap-7">
                    ...
                    <p className="text-xs xs:text-sm lg:w-150 xl:w-180">
                        {data.content}
                    </p>
                </div>
                ...
                <p className="flex items-center text-center absolute bottom-5 left-0 lg:left-33 w-full justify-center lg:justify-start text-[9px] xs:text-[12px] md:text-xs px-15 text-gold opacity-50">
                    {dictionary.noteD}
                </p>

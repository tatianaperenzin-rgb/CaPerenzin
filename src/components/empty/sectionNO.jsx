...
import SectionO from "../home/sectionO";
        ...
        <div className="relative w-full">
                    ...
                    >
                        ...
                        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center">
                            <SectionN
                                ...
                                lang={lang}
                                className="h-full justify-center !pb-0"
                            />
                        </div>
                    </motion.div>
                </div>
            ...
            >
                ...
                <div className="relative z-10 sticky top-0">
                    <SectionO dictionary={{ ...dictionary.sectionO, assetUi: dictionary.assetUi }} bookingDictionary={dictionary} lang={lang} />
                </div>

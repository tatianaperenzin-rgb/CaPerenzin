    ...
    return (
        <div ref={bubbleRef}>
            <BubbleFrame bubbleClass="p-0" divBubbleCls={`h-dvh`}>
                <div ref={scrollRef} className="w-full h-screen overflow-y-auto snap-y snap-proximity scroll-smooth no-scrollbar overflow-x-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">

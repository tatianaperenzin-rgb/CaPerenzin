...
export default function SectionH({ dictionary, lang }) {
    ...
    const classText = "font-muller  md:pe-7 lg:pe-0 lg:ps-7 xl:ps-0 2xl:ps-50 lg:text-right text-xs xxs:text-sm xs:text-base w-ful  xxs:w-[85%] xs:w-full"
        ...
        <section className="w-full h-full lg:h-dvh flex flex-col lg:flex-row justify-center items-center gap-5  p-2 md:p-5">
            ...
            <div className={`flex w-full  md:h-1/2 lg:h-full lg:w-1/2 bg-gold rounded-3xl xl:rounded-[40px]
                ...
                <div className={`flex flex-col 
                                ${isOpen ? "gap-7 md:justify-between" : "justify-between md:justify-center lg:justify-end "}
                                `}>
                    ...
                    <div className="flex flex-col
                        ...
                        <p className={`pt-7 md:pt-10 xl:pt-27 text-balance ${classText}`}>{dictionary.content.paragraphOne}</p>
                    ...
                    <div className="hidden flex flex-col  xl:justify-end xl:items-end ">
